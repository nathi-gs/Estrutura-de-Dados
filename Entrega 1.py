...
def autenticar_usuario():
    while True:
        ...
        # Verificar se o usuário e senha correspondem ao que está no arquivo
        with open("usuario.txt", "r") as arquivo_usuario:
            linha = arquivo_usuario.readline().strip()
            usuario_salvo, senha_salva = linha.split(",")
...
def salvar_produtos_em_arquivo(produtos):
    with open("produtos.txt", "w") as arquivo_produtos:
        for produto in produtos:
            arquivo_produtos.write(f"{produto['id']},{produto['descricao']},{produto['peso']},{produto['valor']},{produto['fornecedor']}\n")
